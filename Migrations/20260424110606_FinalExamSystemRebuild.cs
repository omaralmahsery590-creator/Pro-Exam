...
{
    /// <inheritdoc />
    public partial class FinalExamSystemRebuild : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Monterings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Monterings_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Monterings_Exams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Monterings_DoctorId",
                table: "Monterings",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_Monterings_ExamId",
                table: "Monterings",
                column: "ExamId");
